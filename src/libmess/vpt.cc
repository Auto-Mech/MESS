...
int main (int argc, char* argv [])
{
  ...
  Key  temp_key("TemperatureRange[K]"     );
  Key sfreq_key("RealFrequencies[1/cm]"   );
  Key ifreq_key("ImaginaryFrequency[1/cm]");
  Key cubic_key("CubicAnharmonicities"    );
  Key quart_key("QuarticAnharmonicities"  );
