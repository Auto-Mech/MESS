...
namespace Molpro {
  ...
  void backup (const std::string&) throw(Error::General);
}
...
void Molpro::backup (const std::string& mess) throw(Error::General)
{
...
void Molpro::init(std::istream& from) throw(Error::General)
{
...
void Molpro::pot (const std::vector<Atom>& molec, Array<double>& ener_data, int flags) throw(Error::General)
{
